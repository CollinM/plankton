...
public class Experiment5 {
	...
	public static void main(String[] args) throws IOException {
		...
		Logger logger = LoggerFactory.getLogger(Experiment5.class);
		...
		pipe.addProcessor(new SubRegionAverage(8, 0));
		pipe.addDataSink(new JsonSink(Paths.get("output/experiment5.json")));
