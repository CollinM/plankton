...
public class Experiment8_1 {
	...
	public static void main(String[] args) throws IOException {
		...
		Logger logger = LoggerFactory.getLogger(Experiment8_1.class);
		...
		pipe.addProcessor(new ImageHistogramBins(5, 0, 256), true);
		pipe.addDataSink(new JsonSink(Paths.get("output/experiment8_1.json")));
